...
// RN port of frontend/src/components/Dashboard/DashboardSummary/DashboardSummary.tsx.
    ...
    <>
      ...
      <View style={styles.grid}>
        {orderedAreas.map((area) => (
          <View key={area} style={styles.cardWrap}>
            <AreaCard attributes={attributesByArea.get(area)!} />
          </View>
        ))}
      </View>
    </>
