...
// RN port of frontend/src/components/BeachDetail/ReportFlag/hooks/useReportEligibility.ts,
// verbatim — no DOM/RN-specific dependency in here, just fetch + timers.
